...
public class ManagerFrame extends JFrame implements ActionListener {
	...
	JMenuItem readAssign = new JMenuItem("Read All Tasks to Employee");
	
	JMenuItem addEmployee = new JMenuItem("Assign Employee");
	JMenuItem deleteEmployee = new JMenuItem("Delete Employee");
	JMenuItem readEmployee = new JMenuItem("ReadAll  Employee");
	JMenuItem updateEmployee = new JMenuItem("Update Employee");
	
	JMenuItem addCustomer = new JMenuItem("Assign Customer");
	...
	JMenuItem addInsurance = new JMenuItem("Assign Insurance");
	...
	JMenuItem addOrder = new JMenuItem("Assign Order");
		...
		addButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(ManagerFrame.compareDate(startDate,endDate) && (Integer.parseInt(discount)>0 && Integer.parseInt(discount)<=100)
					...
					app.updateRepair(ID, startDate, endDate, description, Integer.parseInt(discount), Integer.parseInt(totalCost), completion);
		...
		addButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(ManagerFrame.compareDate(startDate,endDate) && (Integer.parseInt(discount)>0 && Integer.parseInt(discount)<=100)
						&& Integer.parseInt(totalCost) == (int)Integer.parseInt(totalCost)
						&& Integer.parseInt(totalCost)>=0) {
					app.addRepair(startDate, endDate, Integer.parseInt(discount), Integer.parseInt(totalCost),description);
	...
	public void addCustomer() {
		...
		JLabel numberVisitsLabel = new JLabel("NumberOfVists");
		...
		numberVisitsChooser.setBounds(100, 200, 150, 60);
	...
	public void updateOrder() {
		...
		addButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				// TODO Auto-generated method stub
				try {
				String BeforeManagerUserName = ((MyOrder) beforePartNumberChooser.getSelectedItem()).getManagerUserName();
				...
				for (int i = 0; i < myOrders.size(); i++) {
					...
					if(AfterManagerUserName.equals(currentOrderManagerUserName) && AfterPartNumber.equals(currentPartNumber)) {
						dontProceed = false;
						break;
					}
				}
				...
				if(BeforeManagerUserName.length() != 0 && AfterManagerUserName.length() != 0 &&
						...
						&& (!BeforeManagerUserName.equals(AfterManagerUserName) && !BeforePartNumber.equals(AfterPartNumber))
						&& dontProceed) {
					app.updateOrders(BeforeManagerUserName, BeforePartNumber, AfterManagerUserName, AfterPartNumber);
				}
				else {
					JOptionPane.showMessageDialog(null, "The Fields are incorrect");
				}
	...
	public void updatemanager() {
		...
		addButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(currentManager.length() != 0 && FirstName.length() != 0 &&
						LastName.length() != 0) {
	...
	public void updateFor() {
		...
		addButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(BeforePartNumber != null && BeforeTaskID != null && AfterPartNumber != null && AfterTaskID != null
		...
		addButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(BeforeRepairID != null && BeforeTaskID != null && AfterRepairID != null && AfterTaskID != null
					...
					app.updateHas(BeforeRepairID, BeforeVehicleVIN, BeforeTaskID, AfterRepairID, AfterVehicleVIN, AfterTaskID);
				}
				else {
					JOptionPane.showMessageDialog(null, "The Fields are incorrect");
				}
		...
		addButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(BeforeRepairID != null && AfterRepairID != null && BeforeVehicleVIN.length() != 0
						&& BeforeCustomer.length() != 0 && AfterVehicleVIN.length() != 0 && AfterCustomer.length() != 0
						&& AfterReceipt.length() != 0 && BeforeVehicleVIN.length() != 0 && AfterVehicleVIN.length() != 0) {
					app.updatePaidBy(BeforeVehicleVIN, BeforeRepairID, BeforeCustomer, BeforeReceipt, AfterVehicleVIN, AfterRepairID, AfterCustomer, AfterReceipt);
				}
				else {
					JOptionPane.showMessageDialog(null, "The Fields are incorrect");
				}
	...
	public void addPaidFor() {
		...
		addButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(VIN.length() != 0 && RepairID != null && InsuranceClaimNumber != null && Receipt.length() != 0) {
	...
	public void updatePaidFor() {
		...
		addButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				String BeforeInsuranceClaimNumber = ((MyPaidFor) beforePartNumberChooser.getSelectedItem()).getInsuranceClaimNumber();
				...
				String AfterReceipt = (String) afterReceiptChooser.getText();
				if(BeforeRepairID != null && AfterRepairID != null && BeforeVehicleVIN.length() != 0
						&& BeforeInsuranceClaimNumber.length() != 0 && AfterVehicleVIN.length() != 0 && AfterInsuranceClaimNumber.length() != 0
						&& AfterReceipt.length() != 0 && BeforeVehicleVIN.length() != 0 && AfterVehicleVIN.length() != 0) {
					app.updatePaidFor(BeforeVehicleVIN, BeforeRepairID, BeforeInsuranceClaimNumber, BeforeReceipt, AfterVehicleVIN, AfterRepairID, AfterInsuranceClaimNumber, AfterReceipt);
				}
				else {
					JOptionPane.showMessageDialog(null, "The Fields are incorrect");
				}
	...
	public void deletePaidFor() {
		...
		deleteButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(VIN.length() != 0 && RepairID != null && InsuranceClaimNumber.length() != 0 && Receipt.length() != 0) {
